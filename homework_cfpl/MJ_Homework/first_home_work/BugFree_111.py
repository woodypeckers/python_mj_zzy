...
class BugFree_Test1(unittest.TestCase):
    ...
    #     driver.find_element_by_id("TestUser_username").send_keys("user_%s" % random.randrange(1, 99))
    #     driver.find_element_by_id("TestUser_realname").send_keys("name_%s" % random.randrange(1, 99))
